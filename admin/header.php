...
<head>
    <title>Admin Dashboard | MSMS</title>
    ...
    <nav class="bg-blue-600 sticky top-0 z-[100] shadow-lg">
        <div class="w-full px-6 md:px-8 py-4 flex flex-col md:flex-row items-center justify-between">
            ...
            <ul class="flex flex-col md:flex-row md:space-x-1 items-center mt-4 md:mt-0">
                <!-- Home Button - Main Portal -->
                <li class="mr-2 md:mr-4">
                    <a href="<?php echo htmlspecialchars($baseS); ?>index.php" class="flex items-center justify-center w-10 h-10 rounded-lg bg-white/10 hover:bg-white/20 text-white transition-all duration-300 group border border-white/20 hover:border-white/40" title="Main Portal">
                        ...
                        ?>
                            ...
                            <div class="p-2 bg-white">
                                <ul class="space-y-1">
                                    ...
                                    <li>
                                        <a href="<?php echo htmlspecialchars($baseS); ?>admin/accounts.php" class="nav-loader-link flex items-center px-4 py-2.5 rounded-xl hover:bg-blue-50 text-slate-600 hover:text-blue-700 transition-all group/item">
                                            <div class="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center mr-3 group-hover/item:bg-blue-200 transition-colors">
                                                <svg class="w-4 h-4 text-blue-600 group-hover/item:text-blue-700" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                                </svg>
                                            </div>
                                            <span class="text-[10px] font-bold uppercase tracking-widest">All Accounts</span>
                                        </a>
                                    </li>
