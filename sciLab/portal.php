    ...
    <div class="relative z-10 w-full flex flex-col items-center text-center px-4 pb-24">
        <div class="mb-8 space-y-4 flex flex-col items-center">
            <div class="inline-flex items-center gap-3 px-6 py-2.5 rounded-2xl bg-black/70 backdrop-blur-md text-white border-2 border-white/30 text-sm font-black uppercase tracking-[0.3em] animate-fade-in shadow-lg drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)]">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232 1.232 3.228 0 4.46s-3.228 1.232-4.46 0L15.3 19.8" /></svg>
                Science Laboratory Portal
            </div>

            <h1 class="text-7xl md:text-9xl font-black tracking-tighter text-white leading-none animate-fade-in-up drop-shadow-[0_10px_40px_rgba(0,0,0,0.8)] [text-shadow:_2px_2px_8px_rgba(0,0,0,0.9)]">
                Science <br class="md:hidden"> <span class="text-blue-400 drop-shadow-[0_0_30px_rgba(59,130,246,0.8)] [text-shadow:_2px_2px_10px_rgba(0,0,0,0.9),_0_0_20px_rgba(59,130,246,0.8)]">Laboratory</span>
            </h1>

            <p class="text-xl md:text-2xl text-white font-semibold max-w-2xl leading-relaxed animate-fade-in-up drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] [text-shadow:_1px_1px_4px_rgba(0,0,0,0.9)]" style="animation-delay: 0.1s;">
                Official student portal for session logging and laboratory attendance tracking.
            </p>
        </div>
        ...
        <div class="flex flex-col items-center gap-10 w-full animate-fade-in-up" style="animation-delay: 0.2s;">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 w-full max-w-3xl">
                <?php $logHref = 'logs/log_book.php'; ?>
                <a href="<?php echo $logHref; ?>"
                    class="group relative flex flex-col h-full min-h-[200px] p-1 bg-gradient-to-br from-blue-400 via-indigo-500 to-purple-600 rounded-[2rem] shadow-[0_0_40px_rgba(59,130,246,0.3)] transition-all duration-500 hover:scale-[1.02] hover:shadow-blue-400/50">
                    <div class="w-full flex-1 py-8 px-6 rounded-[1.9rem] bg-[#0f172a]/90 backdrop-blur-xl border border-white/10 flex flex-col justify-between overflow-hidden">
                        <div class="flex flex-col items-start text-left mb-4">
                            ...
                            <span class="text-blue-300 text-xs font-bold uppercase tracking-widest opacity-80">Identify yourself to proceed</span>
                        </div>
                        <div class="flex justify-end w-full">
                            <div class="bg-blue-500/20 p-3 rounded-2xl border border-blue-400/30 backdrop-blur-md">
                                <svg class="w-7 h-7 text-white transition-transform duration-500 group-hover:translate-x-2" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            </div>
                        </div>
                    </div>
                </a>
                <a href="reservation/lab_booking.php"
                    class="group relative flex flex-col h-full min-h-[200px] p-1 bg-gradient-to-br from-emerald-400 via-teal-500 to-blue-600 rounded-[2rem] shadow-[0_0_40px_rgba(16,185,129,0.2)] transition-all duration-500 hover:scale-[1.02] hover:shadow-emerald-400/40">
                    <div class="w-full flex-1 py-8 px-6 rounded-[1.9rem] bg-[#0f172a]/90 backdrop-blur-xl border border-white/10 flex flex-col justify-between overflow-hidden">
                        <div class="flex flex-col items-start text-left mb-4">
                            <span class="text-white text-xl md:text-2xl font-black uppercase tracking-tighter mb-2">Book Laboratory</span>
                            <span class="text-emerald-300 text-xs font-bold uppercase tracking-widest opacity-80">Reserve equipment & space</span>
                        </div>
                        <div class="flex justify-end w-full">
