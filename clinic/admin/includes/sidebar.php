...
$clinic_base = defined('CLINIC_BASE') ? CLINIC_BASE : ((defined('BASE_URL') ? BASE_URL : '') . '/clinic');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="nav-menu">
            <div class="nav-section">
             ...
             <a href="<?php echo htmlspecialchars($clinic_base); ?>/admin/admin.php" class="nav-item ">
             ...
             <a href="<?php echo htmlspecialchars($clinic_base); ?>/admin/pages/patientrecords.php" class="nav-item ">
                ...
                <a href="<?php echo htmlspecialchars($clinic_base); ?>/admin/pages/recordslogs.php" class="nav-item">
                    <div class="nav-icon">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo htmlspecialchars($clinic_base); ?>/admin/pages/reportsComplaint.php" class="nav-item">
                    <div class="nav-icon">
                ...
                <a href="<?php echo htmlspecialchars($clinic_base); ?>/admin/pages/reportslogs.php" class="nav-item">
                    <div class="nav-icon">
                ...
                <a href="<?php echo htmlspecialchars($clinic_base); ?>/admin/pages/statistics.php" class="nav-item">
                    <div class="nav-icon">
