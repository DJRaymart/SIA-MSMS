...
$yearly_monthly_stats   = getYearlyMonthlyStats($conn, $selected_year); 
...
<div class="max-w-15xl mx-auto px-4 sm:px-6 statistics-page">
    <link rel="stylesheet" href="../assets/css/statistics.css">
    <style>
        /* Match Reports Logs alignment: full width, same left edge as page title */
        .statistics-page { width: 100%; margin-left: 0 !important; margin-right: 0 !important; background: transparent; }
        .statistics-page .container { width: 100%; max-width: none; margin: 0; }
    </style>
