...
<div class="max-w-15xl mx-auto px-4 sm:px-6 patientrecords-page">
    <link rel="stylesheet" href="../assets/css/patient.css">
    <style>
        /* Match Reports Logs alignment: full width, same left edge as page title */
        .patientrecords-page { width: 100%; margin-left: 0 !important; margin-right: 0 !important; background: transparent; }
        .patientrecords-page .container { width: 100%; max-width: none; margin: 0; }
    </style>
