...
$web_path = (defined('CLINIC_BASE') ? CLINIC_BASE : ((defined('BASE_URL') ? BASE_URL : '') . '/clinic')) . '/assets/pictures/format.png';
$server_path = dirname(__DIR__, 2) . '/assets/pictures/format.png';
...
<div class="max-w-15xl mx-auto px-4 sm:px-6 reportslogs-page">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
<link rel="stylesheet" href="../assets/css/reportslogs.css">
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>

<style>
/* Match other clinic sub-modules: no white page box, full-width like Patient Records / Statistics */
.reportslogs-page {
    width: 100%;
...
.reportslogs-page .reportslogs-container {
    width: 100%;
    padding: 0 0 2rem 0;
}
.reportslogs-page .date-range-filter,
.reportslogs-page .stats-cards,
.reportslogs-page .grade-stats-section,
.reportslogs-page .chart-section {
    width: 100%;
}
.reportslogs-page .filter-row {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));
    gap: 1rem;
    align-items: end;
}
.reportslogs-page .filter-buttons {
    display: flex;
    gap: 0.75rem;
    margin-top: 1rem;
    flex-wrap: wrap;
}
.reportslogs-page .section-title {
    display: flex;
...
/* Header card: match Reports by Complaint (blue gradient, title, subtitle, print button) */
.reportslogs-page .header {
...
.reportslogs-page .header p {
    font-size: 0.95rem;
    opacity: 0.95;
    margin: 0 0 0.75rem 0;
}
.reportslogs-page .header .table-actions {
    display: flex;
    justify-content: flex-end;
    gap: 0.5rem;
}
.reportslogs-page .header .action-btn.print {
...
.reportslogs-page .header .action-btn.print:hover {
    background: white;
}
...
@media print {
    ...
    .reportslogs-container{ max-width: none; padding:0; }
}
</style>
    <div class="reportslogs-container">
            <!-- Header (matches Reports by Complaint design) -->
...
if(isset($logs_stmt)) $logs_stmt->close();
