...
if ($records_per_page === 'all') {
    $records_per_page_int = 999999999; 
} else {
...
<div class="max-w-15xl mx-auto px-4 sm:px-6 recordslogs-records-page">
<link rel="stylesheet" href="../assets/css/patient.css">
<style>
    /* Match Reports Logs alignment: full width, left-aligned like other clinic pages */
    .recordslogs-records-page { width: 100%; margin-left: 0 !important; margin-right: 0 !important; background: transparent; }
    .recordslogs-records-page .main-content { margin-left: 0 !important; width: 100%; max-width: none; }
    .recordslogs-records-page .container { width: 100%; max-width: none; margin: 0; text-align: left; }
    .recordslogs-records-page .header,
    .recordslogs-records-page .header h1,
    .recordslogs-records-page .filter-section,
    .recordslogs-records-page .filter-row,
    .recordslogs-records-page .table-container { text-align: left; }
    .recordslogs-records-page .header h1 { justify-content: flex-start; }
</style>
