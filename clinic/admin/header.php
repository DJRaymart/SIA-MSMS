...
<body class="bg-slate-50">
    <script>
    window.CLINIC_BASE = <?php echo json_encode($clinic_base); ?>;
    </script>
        ...
        <div class="w-full px-6 md:px-8 py-4 flex flex-col md:flex-row items-center justify-between">
            ...
            <ul class="flex flex-col md:flex-row md:space-x-1 items-center mt-4 md:mt-0">
                <li class="mr-2 md:mr-4">
                    <a href="<?php echo htmlspecialchars($base ? $base . '/' : '/'); ?>index.php" class="flex items-center justify-center w-10 h-10 rounded-lg bg-white/10 hover:bg-white/20 text-white transition-all duration-300 group border border-white/20 hover:border-white/40" title="Main Portal">
