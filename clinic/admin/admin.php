...
include dirname(__DIR__) . '/includes/conn.php';
...
require_once dirname(__DIR__) . '/header_unified.php';
?>

<div class="max-w-15xl mx-auto px-4 sm:px-6 clinic-dashboard-page">
<style>
:root {
...
/* Match Reports Logs alignment: full width, no centering, same left edge as page title */
.clinic-dashboard-page { width: 100%; margin-left: 0 !important; margin-right: 0 !important; background: transparent; }
.clinic-dashboard-page .clinic-dashboard .container { width: 100%; max-width: none; margin: 0; background: white; border-radius: 12px; box-shadow: 0 5px 20px rgba(0,0,0,0.08); overflow: hidden; }
.quick-stats {
            display: grid;
...
<div class="clinic-dashboard"><div class="container">
...
<?php
require_once dirname(__DIR__) . '/footer_unified.php';
$conn->close();
?>